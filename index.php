...
<nav class="navbar" id="navbar">
    ...
    <?php // This is the Code to Redirect the Header4 if ever na click siya ni user mag reredirect siya into url or site
if (isset($_GET['redirect']) && $_GET['redirect'] === 'grp7') {
    header('Location: https://docs.google.com/spreadsheets/d/1In3oA6woUu2TqexNlN7ypqxmuSLUdgs1NPwXx574rEc/edit?fbclid=IwZXh0bgNhZW0CMTEAAR1i1nbTdmOqu3fl5whnKzxoUWtSpbmdEXJomcss8RGs7YWQ8oK4Fo2Lw7A_aem_WwH1tr06iBM_T2vKYpeLOA&gid=0#gid=0'); 
    exit; 
}
?>
    ...
    <div class="team-sectio" id="team-sectio">
        ...
        <h4><a href="?redirect=grp7" style="color: rgb(164, 180, 19);">><b>Grp 7</b></h4>
